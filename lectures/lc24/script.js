    ...
    let quote = [
      {
        ...
        text: "બાળકને સારું ખાવાનું, પાણી અને સ્વચ્છ હવા જ શ્રેષ્ઠ દવા છે.",
      },
      {
        author: "Mahatma Gandhi (મહાત્મા ગાંધી)",
        text: "તમે જે બદલાવ દુનિયામાં જોવા માંગો છો તે બનો.",
      },
      {
        author: "Kavi Kalapi (કવિ કલાપી)",
        text: "હા ! પસ્તાવો – વિપુલ ઝરણું સ્વર્ગથી ઊતર્યું છે, પાપી તેમાં ડૂબકી દઈને પુણ્યશાળી બને છે!",
      },
      {
        author: "Kavi Narmad (કવિ નર્મદ)",
        text: "ડગલું ભર્યું કે ના હઠવૂં ના હઠવૂં",
      },
    ];
